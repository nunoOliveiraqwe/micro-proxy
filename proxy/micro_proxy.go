...
func NewMicroProxy(conf configuration.NetworkConfiguration) (*MicroProxy, error) {
...
func (m *MicroProxy) StartAcmeManager(conf *configuration.ACMEConfig) error {
	if conf == nil {
...
func (m *MicroProxy) AddHttpServer(conf configuration.HTTPListener) error {
...
func (m *MicroProxy) AddTcpServer(conf configuration.TCPListener) {
	//TODO
}

func (m *MicroProxy) initializeHttpNetworkStackFromConf(conf configuration.NetworkConfiguration) error {
